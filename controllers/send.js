 ...
 * @param {*} number 
 */
const sendMessage = async (client, number = null, text = null, trigger = "salida") => {
   setTimeout(async () => {
    number = cleanNumber(number)
    const message = text
...
const sendMessageList = async (client, number = null, text = null, trigger = "salida") => {
   setTimeout(async () => {
    number = cleanNumber(number)
    const message = text
    client.sendMessage(number, message);
...
const sendMessageButton = async (client, number = null, text = null, actionButtons) => {
    ...
    console.log(`⚡⚡⚡ Enviando mensajes....Botton`);
}
...
module.exports = { sendMessage, sendMedia, lastTrigger, sendMessageButton, readChat, sendMediaVoiceNote, sendMessageList }